import { Box, Card, Chip, Grid, Rating, Tooltip, Typography } from '@mui/material';
            ...
            >
              <Grid container>
                ...
                <Grid item pr={2}>
                  ...
                  <Box pt={2} pl={2}>
                    <Typography sx={{ fontWeight: "500", color: "green" }} component="div">
                      {new Date(borrowBook.issueDate).toLocaleString('en-US', options)}
                    </Typography>
                  </Box>
                  <Box pt={2} pl={2}>
                    <Typography sx={{ fontWeight: "600" }} component="div">
                  ...
                  <Box pt={2} pl={2}>
                    <Typography sx={{ fontWeight: "500", color: "green" }} component="div">
                      ...
                      ) : new Date(borrowBook.returnDate).toLocaleString('en-US', options)}
                    </Typography>
                  </Box>
                </Grid>
              </Grid>
